...
START_TEST(s21_test_from_decimal_to_int_3) {
  s21_decimal a = {{{INT32_MAX, INT32_MAX, INT32_MAX, 0}}};
  check = 0;
...
START_TEST(s21_test_from_decimal_to_int_8) {
  s21_decimal a = {{{UINT32_MAX, UINT32_MAX, UINT32_MAX, UINT32_MAX}}};
  check = 0;
  code = s21_from_decimal_to_int(a, &result);
  ck_assert_int_eq(result, check);
  ck_assert_int_eq(code, 1);
...
START_TEST(s21_test_from_decimal_to_int_9) {
  s21_decimal a = {{{INT32_MAX, 0, 0, INT32_MIN}}};
  check = -INT32_MAX;
  code = s21_from_decimal_to_int(a, &result);
  ck_assert_int_eq(result, check);
  ck_assert_int_eq(code, 0);
